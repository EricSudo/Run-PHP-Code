				...
				<div id="help_window">
					<div style="padding: 10px;">
						...
						<p>
							...
							&copy; Created By : Eric<br />
						</p>

						<a class="button" href="https://github.com/EricSudo/Run-PHP-Code)"><i class="fa fa-github"></i> GitHub </a><br>
					</div>

					<div class="subdrop with_icon" style="text-align: left;">
						<i class="fa fa-users"></i> contact us
						<div>
							<ul>
								<li><label><a href="https://t.me/SudoEric"> Telegram</a></label></li>
								<li><label><a href="https://t.me/PvEric"> Channel</a></label></li>
								<li><label><a href="https://github.com/EricSudo"> GitHub</a></label></li>
							</ul>
						</div>
					</div>
